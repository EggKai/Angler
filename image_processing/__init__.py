...
class DownloadFile:
    ...
    def __enter__(self) -> Optional[List[str]]:
        ...
        with ThreadPoolExecutor() as executor:
            future_to_url = {executor.submit(self._download_image, url): url for url in self.urls if self.urls}
            for future in as_completed(future_to_url):
                temp_path = future.result()
                if temp_path:
                    self.temp_file_paths.append(temp_path)
        return self.temp_file_paths if self.temp_file_paths else []
...
if __name__ == "__main__":
    ...
    image_QRs:List[str] = [
        ...
        "https://mail.google.com/mail/u/0?ui=2&ik=0c364b4010&attid=0.1&permmsgid=msg-f:1824118956093780920&th=19509286a606b3b8&view=fimg&fur=ip&permmsgid=msg-f:1824118956093780920&sz=s0-l75-ft&attbid=ANGjdJ9Xw9qN16MOmJoJJMfN3nagtheUso-_a3vuqADMRb-h4autbtnVWOkxsui_-KHtm_vWY6xgTL4ofRrLhAHeMP_PIjfbOVcsc_OXZfWrrip_mCIO7XCMuym2kq4&disp=emb&realattid=ii_m7622xpk0&zw"
    ]
